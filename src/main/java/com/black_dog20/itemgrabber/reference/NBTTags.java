...
public final class NBTTags {
	public static final String BELT = "GIG_MAGNET_BELT";
	public static final String DROPPED_BY = "GIG_DROPPED_BY";
	...
	public static final String HAS_MAGNET = "GIG_HAS_MAGNET";
	public static final String RANGE = "GIG_RANGE";
